namespace EnterpriseAI.Services.Interfaces
{
    ...
    {
        Task<IEnumerable<FormDto>> GetAllAsync(string currentUserId, bool isAdmin, CancellationToken cancellationToken = default);
        Task<FormDetailDto?> GetByIdAsync(string id, string currentUserId, bool isAdmin, CancellationToken cancellationToken = default);
        Task<FormSchemaDto?> GetSchemaAsync(string id, string currentUserId, bool isAdmin, CancellationToken cancellationToken = default);
